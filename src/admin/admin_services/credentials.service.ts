...
export class CredentialsService {
    ...
    async updateItem(credentials_id: string, updateData: Partial<Credentials>): Promise<Credentials> {
        const credential = await this.credentialsRepository.findOneBy({ id: credentials_id });
        if (!credential) {
